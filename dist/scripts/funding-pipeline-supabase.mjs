"use strict";
import { FundingPipeline } from './funding-pipeline';
        ...
        try {
            ...
            return {
                ...
                statistics: {
                    ...
                    highestRate: validRates.length > 0 ? validRates.reduce((max, curr) => Math.abs(curr.predicted) > Math.abs(max.predicted) ? curr : max) : null,
