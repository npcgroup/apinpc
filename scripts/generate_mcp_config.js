          ...
          "queries": [
            {
              ...
              "sql": "SELECT hypertable_name, chunk_name, range_start, range_end, is_compressed FROM timescaledb_information.chunks WHERE hypertable_name = '{{table}}' ORDER BY range_start DESC LIMIT 20",
              "parameters": [
                {
                  "name": "table",
                  "type": "string",
            ...
            },
            {
              ...
              "sql": "SELECT format('%s',hypertable_name) as table_name, pg_size_pretty(before_compression_total_bytes) as before_compression, pg_size_pretty(after_compression_total_bytes) as after_compression, round(after_compression_total_bytes::numeric / nullif(before_compression_total_bytes, 0) * 100, 2) as compression_ratio FROM timescaledb_information.compression_settings ORDER BY after_compression_total_bytes / nullif(before_compression_total_bytes, 0)",
              "parameters": []
            }
          ]
        }
