...
def push_to_supabase(df):
    ...
    try:
        ...
        # Insert new records
        result = supabase.table('gate_market_data').insert(records).execute()
...
def fetch_market_data():
    """
    Fetch comprehensive market data for all perpetual contracts from Gate.io
...
def save_market_data_json(df):
    ...
    output_dir = Path('gate_market_data')
